...
def doubleCar(x1, w1, x2, w2, ser):
    ...
    if(x1 < 0.25 and car1 <= 0.25 and x2 >= 0.75 and car2 > 0.75):
        posCar = "a" # module 4 is turned off
    elif((x1<0.25 and car1<=0.25 and x2>=0.25 and x2<0.5 and car2>0.25 and car2<=0.5) or (x1<0.25 and car1<=0.25 and x2<0.25 and car2<=0.5) or (x1>=0.25 and x1<0.5 and car1>0.25 and car1<=0.5 and x2>=0.25 and x2<0.5 and car2>0.25 and car2<=0.5) or (x1<0.25 and car1<=0.50 and x2>=0.25 and x2<0.5 and car2>0.25 and car2<=0.5) or(x1<0.25 and car1<=0.5 and x2<0.25 and car2<=0.5)):
        posCar = "e" #module 3 and 4 turned off
    elif((x1>=0.5 and car1<=0.75 and x2>=0.5 and car2<=0.75) or (x1>=0.5 and x1<0.75 and car1>0.5 and car1<=0.75 and x2>=0.5 and x2<0.75 and car2<0.5 and car2<=0.75) or (x1>=0.5 and x1<0.75 and car1>0.5 and car1<=0.75 and x2>=0.5 and car2>=0.75) or (x1>=0.5 and car1>=0.75 and x2>=0.75 and x2<1 and car2>0.75 and car2<=1) or (x1>=0.5 and car1>=0.75 and x2>=0.5 and car2>0.75)):
...
# Open the video file
video_path = "/Users/yashjasani/trynthtime/data/test_video3.mp4"
# video_path = "/Users/yashjasani/Desktop/test/2_car_right_vid.mp4"
